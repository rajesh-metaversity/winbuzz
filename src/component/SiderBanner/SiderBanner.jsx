...
export const SiderBanner = () => {
	...
	if (!isBreakPoint) {
		return (
			<>
				<ModalComponent Elememt={<Logout />} open={loginFormModal} setOpen={setLoginFormModal} />
				...
				<div className="side_banner-sub_cont">
					...
					<div className="bottom_images">
						{casinoData?.map((data, index) => (
							<span key={index + data?.imageUrl} className="image_cont" onClick={() => setLoginFormModal(true)}>
