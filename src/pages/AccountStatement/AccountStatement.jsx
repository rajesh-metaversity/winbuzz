...
const AccountStatement = () => {
  ...
  const submit = () => {
    ...
    accountStatementBody2.fromDate =
      accountStatementBody2.fromDate.format(dateFormat);
    accountStatementBody2.toDate =
      accountStatementBody2.toDate.format(dateFormat);
        ...
        <div className="record-search">
          ...
          <span>
            <input
              ...
              value={accountStatementBody?.userId}
            />
